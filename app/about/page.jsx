    ...
    <>
      <div className='bg-[url("/banner-bg.png")] bg-cover bg-center flex flex-col justify-center items-center '>
        <AboutSection />
          ...
          <div data-aos='fade-up' className='container mx-auto grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-5'>
            <AboutBox
          ...
          <div data-aos='fade-up' className='flex flex-col gap-4 my-24 justify-center items-center'>
