                  ...
                  <div className="sm:flex sm:items-start">
                    <div className="mt-3 flex flex-col gap-4 w-full sm:mt-0 sm:text-left">
                      ...
                      <input
                        ...
                        className='border border-solid border-gray-400 text-[18px] !important shadow-none outline-none rounded-[100px] h-[55px] px-6'
                      />
                      <button onClick={handleSignup} className="bg-primary border text-[18px] border-primary hover:bg-white px-6 py-3  rounded-full">
                        Create Account
                      </button>
                      <hr />
                      ...
                      <div className="flex flex-col items-center gap-4 my-10">
                        ...
                        <div className="flex gap-5">
                          <img src="/icons/google.svg" alt="as" className='cursor-pointer' onClick={handleGoogleSignup} />
