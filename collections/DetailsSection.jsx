...
export const DetailsSection = ({setSignupModal}) => {
  return (
    <div
      data-aos='fade-up'
      className='flex flex-col justify-center items-center container mx-auto gap-8 mt-[-70px] md:mt-0'
    >
      <h2 className={`md:text-5xl text-[22px] max-w-[815px] font-[500] md:leading-[62px] text-center ${poppins.className}`}>
      ...
      <div className='flex flex-col md:flex-row gap-10'>
        <div className="bg-[url('/pic1.png')] bg-cover bg-center bg-no-repeat p-9 flex justify-end items-end md:min-h-[450px] min-h-[220px] md:rounded-3xl rounded-xl renting-spaces-item">
          <h2 className={`md:text-3xl text-[20px] text-white font-[500] z-10 ${poppins.className} `}>
